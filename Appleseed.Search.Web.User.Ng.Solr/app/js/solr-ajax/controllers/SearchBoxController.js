 ...
 */
function SearchBoxController($scope, $rootScope, $attrs, $location, $route, $routeParams, $window, SolrSearchService, Utils) {
    ...
    //$scope.appleseedsSearchSolrProxy = $rootScope.appleseedsSearchSolrProxy;
...
SearchBoxController.$inject = ['$scope','$rootScope', '$attrs', '$location', '$route', '$routeParams', '$window', 'SolrSearchService', 'Utils'];
